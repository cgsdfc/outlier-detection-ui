...
"}")
        ...
        self.pbDemo = QtWidgets.QPushButton(self.centralwidget)
        self.pbDemo.setGeometry(QtCore.QRect(170, 320, 231, 91))
        self.pbDemo.setStyleSheet("/*  ------------------------------------------------------------------------  */\n"
"/* QtMaterial - https://github.com/UN-GCPDS/qt-material\n"
"/* By Yeison Cardona - GCPDS\n"
"/*  ------------------------------------------------------------------------  */\n"
"\n"
...
"  background-color: transparent;\n"
"}")
        self.pbDemo.setObjectName("pbDemo")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(490, 220, 120, 80))
        self.groupBox.setObjectName("groupBox")
        self.frame = QtWidgets.QFrame(self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(250, 200, 120, 80))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pbDemo.setText(_translate("MainWindow", "俺是一个按钮"))
        self.groupBox.setTitle(_translate("MainWindow", "你好"))
