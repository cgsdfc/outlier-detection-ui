...
"}")
        ...
        self.lbData = QtWidgets.QLabel(self.groupBox_3)
        self.lbData.setMaximumSize(QtCore.QSize(1030, 699))
        self.lbData.setText("")
        self.lbData.setScaledContents(True)
        self.lbData.setAlignment(QtCore.Qt.AlignCenter)
        self.lbData.setObjectName("lbData")
        self.gridLayout_6.addWidget(self.lbData, 0, 0, 1, 1)
